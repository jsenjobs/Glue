...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        BlackUrlDao.createTable(db, ifNotExists);
        BookMarkDao.createTable(db, ifNotExists);
        DownloadModeDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        BlackUrlDao.dropTable(db, ifExists);
        BookMarkDao.dropTable(db, ifExists);
        DownloadModeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(BlackUrlDao.class);
        registerDaoClass(BookMarkDao.class);
        registerDaoClass(DownloadModeDao.class);
