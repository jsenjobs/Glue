...
class WhiteRuleEditAdapter(private val context0: Context, private val list: List<WhiteDomain>) : ArrayAdapter<WhiteDomain>(context0, R.layout.ad_rule_item, list) {
