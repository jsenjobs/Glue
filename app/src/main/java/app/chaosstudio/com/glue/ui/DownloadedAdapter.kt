...
class DownloadedAdapter(private val context0: Context, private val list: List<DownloadMode>) : ArrayAdapter<DownloadMode>(context0, R.layout.list_fragment_downloaded_item, list) {
    private val layoutResId: Int = R.layout.list_fragment_downloaded_item
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (view == null) {
            ...
            holder.url = view!!.findViewById(R.id.download_url)
            view.tag = holder
        } else {
